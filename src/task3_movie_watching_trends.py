...
def analyze_movie_watching_trends(df):
    ...
    trends_df = trends_df.orderBy("WatchedYear")
...
def main():
    ...
    output_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-EricHedgepeth/Outputs/movie_watching_trends.csv"
